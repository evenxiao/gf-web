...
type menuColumns struct {
    ...
    Url         string //                                        
    Level       string // 层级                                   
    LeverCode   string // 层级标识 特征为拼接所有上级id及自身id  
    Type        string // 类型 1 菜单 2 功能操作                 
    IsShow      string // 是否显示 1 是 2 否                     
    Status      string // 状态 1 有效 2 无效                     
    OrderNum    string // 排序号  优先级越小越前                 
    DeleteFlag  string // 删除标记 0 未删除 1 已删除             
    CreateTime  string //                                        
    UpdateTime  string //
}
...
var (
	...
	Menu = &MenuDao{
		M:     g.DB("default").Model("menu").Safe(),
		Table: "menu",
		Columns: menuColumns{
			MenuId:     "menu_id",      
            MenuName:   "menu_name",    
